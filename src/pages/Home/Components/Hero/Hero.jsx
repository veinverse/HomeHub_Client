      ...
      >
        <div className="flex flex-col items-center text-center p-5 lg:p-8 text-white">
          ...
          <p className="text-[20px]">
            ...
            praesent elit et laoreet amet tortor, mauris
          </p>
          <br />
          <button className="text-[18px] h-[51px] text-white font-medium bg-gradient-to-r from-[#75A7A5] to-[#607894] py-2 px-4 rounded-md shadow-[1px_4px_10px_rgba(0,0,0,0.25)]">
            View Properties
          </button>
        </div>
      </div>
