...
const FilterBar = ({ locations, properties }) => {
    ...
    return ( 
        <>
            <div className="flex flex-col items-center text-white -mt-14 mb-6 hidden md:flex">
                ...
                <div className="flex flex-row justify-between items-center p-6 px-9 bg-[#2A4953] lg:w-3/5 rounded-lg bg-opacity-90">
                    <div className="flex flex-row">
                        <svg width="38" height="38" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M19.5 21.125C22.1924 21.125 24.375 18.9424 24.375 16.25C24.375 13.5576 22.1924 11.375 19.5 11.375C16.8076 11.375 14.625 13.5576 14.625 16.25C14.625 18.9424 16.8076 21.125 19.5 21.125Z" stroke="white" className="stroke-[2px]"/>
                            <path d="M19.5 3.25C16.0522 3.25 12.7456 4.61964 10.3076 7.05761C7.86964 9.49558 6.5 12.8022 6.5 16.25C6.5 19.3245 7.15325 21.3362 8.9375 23.5625L19.5 35.75L30.0625 23.5625C31.8468 21.3362 32.5 19.3245 32.5 16.25C32.5 12.8022 31.1304 9.49558 28.6924 7.05761C26.2544 4.61964 22.9478 3.25 19.5 3.25V3.25Z" stroke="white" className="stroke-[2px]"/>
                        </svg>
                        <div className="pl-2">
                            ...
                            <select className="bg-transparent cursor-pointer font-light pr-1 border-none	border-0 w-auto">
                                ...
                                <option key={location.id} className="text-sm bg-white text-[#2A4953] px-4 py-2 cursor-pointer"> {location.place} </option>
                                ))}
                            </select>
                        </div>
                    </div>
                        ...
                        <div className="pl-2">
                            ...
                            <select className="bg-transparent cursor-pointer font-light pr-1 border-none border-0 w-auto">
                                {properties && properties.map((property) => (
                                    <option key={property.id} className="text-sm bg-white text-[#2A4953] px-4 py-2 cursor-pointer">
                                        {property.pty}
                                    </option>
                                ))}
                            </select>
                    ...
                    <div>
                        <button type="submit" className="p-2.5 text-sm font-medium text-white bg-white-700 rounded-lg border border-white-700 hover:bg-white-800 focus:ring-4 focus:outline-none focus:ring-white-300 dark:bg-white-600 dark:hover:bg-white-700 dark:focus:ring-white-800 bg-white">
            ...
            <div className='flex items-center flex-col py-6'>
                ...
                <div className="flex flex-row">
                    <img src={sb} alt="" className="w-[82px] h-[78px] lg:w-[150px] lg:h-[140px]" />
                    <img src={sb} alt="" className="w-[82px] h-[78px] lg:w-[150px] lg:h-[140px]" />
                    <img src={sb} alt="" className="w-[82px] h-[78px] lg:w-[150px] lg:h-[140px]" />
                    <img src={sb} alt="" className="w-[82px] h-[78px] lg:w-[150px] lg:h-[140px]" />
                    <img src={sb} alt="" className="w-[82px] h-[78px] lg:w-[150px] lg:h-[140px]" />
